...
As an example, case 2 is a 10-node system, the values of nodes 1-10 correspond to 1-10 respectively, and the original adjacency matrix A is as shown in the table~\ref{tab:Error-A}.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}ll@{}}
    \toprule
    physical world          & algorithms                   \\ \midrule
    ...
    remove a Misaka         & disconnect a node               \\ \bottomrule
    \end{tabular}
