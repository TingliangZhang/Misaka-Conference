...
To illuminate information transmission visualization with Misaka, we assume there is a 3-node system. The initial output is random, assuming 5MW, 2MW, and 1MW. And the transition matrix Q is:
