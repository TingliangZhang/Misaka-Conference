...
To illuminate information transmission visualization with Misaka, we assume there is a 3-node system. The initial output is random, assuming 5MW, 2MW, and 1MW. Goal is changed the output to 1: 1: 1, to achieve the principle of equal increase rate, and the economy is optimal.

The consensus graph edge weight, indicating that unit 1 transfers 50\% of the output to unit 2
